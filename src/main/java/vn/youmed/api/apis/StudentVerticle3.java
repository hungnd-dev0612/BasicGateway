...
public class StudentVerticle3 extends AbstractVerticle {
    private static final Logger LOGGER = LoggerFactory.getLogger(StudentVerticle3.class);
    ...
    public void getRequestFromEventBus() {
        ...
        vertx.eventBus().consumer("worker3", msg -> {
            LOGGER.warn("Goi vao thang so 3");
