...
public class StudentVerticle2 extends AbstractVerticle {
    private static final Logger LOGGER = LoggerFactory.getLogger(StudentVerticle2.class);
    ...
    public void getRequestFromEventBus() {
        ...
        vertx.eventBus().consumer("worker2", msg -> {
            LOGGER.warn("Goi vao thang so 2");
